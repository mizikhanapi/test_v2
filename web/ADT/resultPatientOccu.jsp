...
<%
    ...
    if (status.equals("1")) {
        ...
        if (idType.equals("pmino")) {
            ...
            searchPatient = "select * from wis_inpatient_episode where OLD_IC_NO='" + idInput + "'";
        } else if (idType.equals("004")) {
            searchPatient = "select * from wis_inpatient_episode where ID_NO='" + idInput + "' AND ID_TYPE='004'";
        } else if (idType.equals("005")) {
            searchPatient = "select * from wis_inpatient_episode where ID_NO='" + idInput + "'AND ID_TYPE='005'";
        }
